    ...
    <div className="App">
      <header className="App-header">
        <div style={{ padding: '8px' }}>
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-chat-left-quote-fill" viewBox="0 0 16 16">
        ...
        <text style={{ fontSize: '16px' }}>
          Something is brewing real soon
        </text>
        <text style={{ marginTop: '32px', fontSize: '12px' }}>
          In the meantime, search here
        </text>
        <input
          type="text"
          value={value}
